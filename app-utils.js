...
export function friendlyError(error) {
  ...
  const messages = {
    ...
    "permission-denied": "Firestore denied this action. Publish the included firestore.rules and make sure your account has the required role.",
    "PERMISSION_DENIED": "Firestore denied this action. Publish the included firestore.rules and make sure your account has the required role.",
